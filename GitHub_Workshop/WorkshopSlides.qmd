...
##        
11. Open a new terminal window from inside of R studio
![](presentationImgs/NewTerminal_RStudio.png){width="700"}                       
...
![](presentationImgs/SHA_RStudio.png){width="500"}
![](presentationImgs/SHA_terminal.png){width="500"}

14. In the Terminal window, use the git revert command to take your repository back to the commit you've chosen
```{shell}
